(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    193: function (e, t, s) {
      Promise.resolve().then(s.bind(s, 7936));
    },
    7936: function (e, t, s) {
      "use strict";
      s.r(t),
      ...
      var i = s(7437),
        ...
        c = s(2916);
      function x() {
        let e = (0, c.ac)({ query: "(max-width: 768px)" }),
          t = (0, d.useRef)(null),
          s = (0, n.Y)(t, { once: !0 }),
          [x, p] = (0, d.useState)(!1),
        ...
        return (0, i.jsxs)("div", {
          className:
            "bg-[#111111] text-white w-full max-w-screen-2xl mx-auto py-11 md:px-16 flex flex-col gap-y-5 md:gap-y-11",
          ref: t,
          children: [
            (0, i.jsxs)(l.E.div, {
              ...
              className:
                "w-full flex flex-col gap-y-6 md:flex-row items-center justify-between py-4",
              children: [
                (0, i.jsx)(r.default, {
                  src: a.Z,
                  alt: "logo",
                ...
                (0, i.jsx)("div", {
                  className:
                    "flex flex-wrap justify-center items-center gap-x-6",
                  children: [
            ...
            (0, i.jsx)(l.E.hr, {
              ...
              animate: s ? { opacity: 1, y: 0 } : {},
              transition: e
                ? { duration: 0.75, delay: 0.6 }
                : { duration: 1, delay: 1.6 },
              className: "border-[#A3A3A3] mx-10 md:mx-0",
            }),
            (0, i.jsxs)(l.E.div, {
              initial: { opacity: 0, y: 90 },
              animate: s ? { opacity: 1, y: 0 } : { opacity: 0, y: 90 },
              transition: e
                ? { duration: 0.75, delay: 0.7 }
                : { duration: 1, delay: 1.7 },
              className:
                "flex flex-col md:flex-row gap-y-4 text-xs md:text-base items-center justify-between text-[#A3A3A3] capitalize",
              children: [
                (0, i.jsx)("p", {
                  children: "Dux Network @2024 all rights reserved",
                }),
                (0, i.jsxs)("div", {
                  className: "relative",
                  children: [
                    (0, i.jsxs)("div", {
                      className:
                        " text-center   py-2.5 px-6 rounded-xl text-xs sm:text-sm md:text-base cursor-pointer",
                      onClick: u,
                      children: ["CA: ", f],
                    }),
                    x &&
                      (0, i.jsx)("div", {
                        className:
                          "absolute top-0 left-1/2 -translate-x-1/2 mt-[-60px] bg-[#FF3838] font-sm font-semibold text-white py-2 px-4 rounded-md",
                ...
                (0, i.jsxs)("div", {
                  ...
                  children: [
                    (0, i.jsx)(o.default, {
                      href: "https://docs.duxnetworkai.com/",
                      target: "_blank",
                      children: (0, i.jsx)("p", {
                    ...
                    (0, i.jsx)(o.default, {
                      href: "https://docs.duxnetworkai.com/",
                      target: "_blank",
                      children: (0, i.jsx)("p", { children: "privacy policy" }),
                    }),
                  ],
                }),
              ],
      ...
      let h = p.fC,
        _ = d.forwardRef((e, t) => {
          ...
          return (0, i.jsx)(p.ck, {
            ref: t,
            className: (0, u.cn)("border-b border-gray-500", s),
            ...r,
          });
        });
      ...
      let j = d.forwardRef((e, t) => {
        ...
        return (0, i.jsx)(p.h4, {
          ...
          children: (0, i.jsxs)(p.xz, {
            ref: t,
            className: (0, u.cn)(
              "flex flex-1 md:items-center items-start justify-between py-6  font-medium transition-all hover:underline [&[data-state=open]>svg]:rotate-180",
              s
            ),
            ...o,
            children: [
              ...
              (0, i.jsx)(f.Z, {
                className:
                  "h-4 -top-3 w-4 shrink-0 transition-transform duration-200",
              }),
            ],
          }),
        });
      });
      j.displayName = p.xz.displayName;
      let g = d.forwardRef((e, t) => {
        let { className: s, children: r, ...o } = e;
        return (0, i.jsx)(p.VY, {
          ref: t,
          className:
            "overflow-hidden text-sm font-normal items-start md:items-center transition-all data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down",
          ...o,
          children: (0, i.jsx)("div", {
            className: (0, u.cn)("pb-4 pt-0", s),
            children: r,
          }),
        });
      });
      g.displayName = p.VY.displayName;
      var y = s(8298);
      let m = [
          {
            value: "item-3",
            Question:
              "What is DSync and how does it contribute to decentralization?",
            answer:
              "DSync aims to establish a permanent and distributed web by employing a content-addressed system instead of HTTP's location-based system. This eliminates the need for a single server's IP address or a centralized CDN, ensuring true decentralization and eliminating central authority.",
          },
          {
            value: "item-5",
            Question: "How can users access websites hosted on Dux Network?",
            answer:
              "In supported browsers like Opera and Brave, users can access websites directly through ENS domain names. For Web3 unfriendly browsers like Chrome or Firefox, access is provided through Dux's Decentralized ENS gateway.",
          },
          {
            value: "item-6",
            Question:
              "What is Dux's Decentralized DNS and how does it enhance privacy?",
            answer:
              "Dux's Decentralized DNS links Web3 domain names directly to file IDs in a decentralized storage network like IPFS, bypassing traditional IP address-based resolutions.",
          },
          {
            value: "item-7",
            Question: "What is Proof of Sync consensus and how does it work?",
            answer:
              "Proof of Sync consensus measures the resource usage (storage, computing, database) by each participant on the network and rewards them accordingly. This unique mechanism ensures a fair and transparent ecosystem.",
          },
          {
            value: "item-8",
            Question: "How does Dux Network prioritize user privacy?",
            answer:
              "Privacy stands as the cornerstone of Dux Network's ethos. Through end-to-end encryption and privacy-preserving protocols, Dux Network safeguards the integrity and confidentiality of user data, empowering users to reclaim control over their digital footprint.",
          },
        ],
        B = (e) => 3 * e;
      function F() {
        ...
        return (0, i.jsxs)("div", {
          ...
          children: [
            (0, i.jsxs)("div", {
              className:
                " flex max-w-[340px] md:max-w-screen-sm w-full flex-col items-center mx-auto py-10",
              ref: e,
              children: [
                (0, i.jsx)(l.E.div, {
                  initial: { opacity: 0, y: 90 },
                  animate: t ? { opacity: 1, y: 0 } : {},
                  transition: { duration: 1, ease: y.YQ },
                  className:
                    "hero-text2 font-semibold md:text-5xl text-4xl text-center",
                  children: "FAQ",
                }),
                (0, i.jsx)(l.E.p, {
                  initial: { opacity: 0, y: 90 },
                  animate: t ? { opacity: 1, y: 0 } : {},
                  transition: { duration: 1, delay: 0.1, ease: y.YQ },
                  className:
                    "self-stretch text-center text-white md:text-base text-sm font-normal mt-4",
                  children:
            ...
            (0, i.jsx)(h, {
              ...
              collapsible: !0,
              className:
                "w-full max-w-[370px] p-2.5  md:p-5 md:max-w-screen-lg mx-auto justify-start md:justify-center items-start text-white transition-all delay-500",
              children: m.map((e, s) =>
                (0, i.jsx)(
                  l.E.div,
                  {
                    ...
                    children: (0, i.jsxs)(_, {
                      value: e.value,
                      children: [
                        (0, i.jsx)(j, { children: e.Question }),
                        (0, i.jsx)(g, { children: e.answer }),
                      ],
                    }),
                  },
                  s
      ...
      let w = d.forwardRef((e, t) => {
        ...
        return (0, i.jsx)(G.fC, {
          ref: t,
          className: (0, u.cn)(
            "relative flex h-10 w-10 shrink-0 overflow-hidden rounded-[12px] md:rounded-full",
            s
          ),
          ...r,
        });
      });
      w.displayName = G.fC.displayName;
      let k = d.forwardRef((e, t) => {
        let { className: s, ...r } = e;
        return (0, i.jsx)(G.Ee, {
          ref: t,
          className: (0, u.cn)("aspect-square h-full w-full", s),
          ...r,
        });
      });
      k.displayName = G.Ee.displayName;
      ...
      C.displayName = G.NY.displayName;
      var S = s(1538);
      let D = (0, s(2218).j)(
        ...
        v = d.forwardRef((e, t) => {
          let { className: s, variant: r, size: o, asChild: a = !1, ...n } = e,
            l = a ? S.g7 : "button";
          return (0, i.jsx)(l, {
            className: (0, u.cn)(D({ variant: r, size: o, className: s })),
            ref: t,
            ...n,
          });
        });
      ...
      let O = [
          { image: "/meme.svg", name: "Meme Analysis Model" },
          { image: "/x.svg", name: "Twitter Activity " },
          { image: "/token.svg", name: "Token  Sentiment" },
          { image: "/bands.svg", name: "Bollinger Bands Model" },
          { image: "/rsi.svg", name: "RSI Model" },
          { image: "/wave.svg", name: "Elliott Wave Model" },
          { image: "/macd.svg", name: "MACD Model" },
          { image: "/airdrop.svg", name: "Airdrop Detection Model" },
        ],
        b = (e) => 0 - e;
      var I = () => {
          let e = (0, c.ac)({ query: "(max-width: 768px)" }),
            ...
            g = (0, d.useRef)(null),
            m = (0, d.useRef)(null);
          (0, n.Y)(g, { once: !0 }), (0, n.Y)(m, { once: !0 });
          let [B, F] = (0, d.useState)(!1);
          return (
            (0, d.useEffect)(() => {
              let e = setTimeout(() => {
                F(!0);
            ...
            (0, i.jsx)("div", {
              ...
              children: (0, i.jsxs)(l.E.div, {
                ...
                animate: s ? { opacity: 1, visibility: "visible" } : {},
                className:
                  "bg-white md:w-full mt-8 mb-8 p-4 md:p-8 mx-auto text-center box-grid",
                children: [
                  (0, i.jsx)(l.E.div, {
                    initial: { opacity: 0, y: 100 },
                    animate: s ? { opacity: 1, y: 0 } : {},
                    transition: { duration: 0.85, delay: 0.4, ease: y.mZ },
                    className:
                      "md:text-5xl text-4xl max-w-[697px] w-full mx-auto leading-tight sm:leading-normal font-semibold mt-4  items-center mb-7 sub-headings text-center not-italic",
                    children: "Train and use AI faster on Dux Network!",
                  }),
                  (0, i.jsxs)("div", {
                    className:
                      "flex gap-2 mt-8 flex-col md:flex-row md:justify-evenly items-center md:ml-8 ",
                    children: [
                      (0, i.jsx)(l.E.div, {
                        initial: { opacity: 0, y: 160 },
                        animate: s ? { opacity: 1, y: 0 } : {},
                        transition: { duration: 1, delay: 0.5, ease: y.mZ },
                        className: "",
                        children: (0, i.jsx)(r.default, {
                          src: U,
                          alt: "alt",
                      ...
                      (0, i.jsxs)(l.E.div, {
                        initial: { opacity: 0, visibility: "hidden" },
                        animate: x ? { opacity: 1, visibility: "visible" } : {},
                        transition: { duraction: 1, delay: 0.6 },
                        className:
                          "box-border rounded-3xl mt-4 md:mt-0 max-w-[850px] max-h-fit w-full mx-auto p-2 box-dots",
                        ref: a,
                        children: [
                          (0, i.jsxs)("div", {
                            className:
                              "flex flex-col items-center md:items-start text-start mt-4 md:mt-0",
                            children: [
                              (0, i.jsx)(l.E.div, {
                                initial: { opacity: 0, y: 90 },
                                ...
                                className:
                                  "text-[#171717] items-start md:text-2xl text-lg font-bold not-italic leading-[32px] md:leading-[36px] md:max-w-[659px] md:p-4 p-3 ",
                                children:
                                  "Dux One Click AI (OCAI) Deployment enables access to exclusive AI models for the masses, trained at Dux Labs over years of historical data.",
                              }),
                              (0, i.jsx)(l.E.div, {
                                ...
                                className:
                                  "text-[#404040] items-start text-base md:text-lg font-medium leading-[24px] md:max-w-[561px] md:p-4 p-3 ",
                                children:
                              ...
                              (0, i.jsx)(o.default, {
                                ...
                                children: (0, i.jsx)(l.E.button, {
                                  ...
                                  animate: x ? { opacity: 1, y: 0 } : {},
                                  transition: e
                                    ? { duration: 1, delay: 1.9, ease: y.YQ }
                          ...
                          (0, i.jsx)(l.E.div, {
                            ...
                            className:
                              "rounded-3xl p-4 mr-2 mb-3 bg-[#F5F5F5]  shrink-0 max-w-[314px]  md:max-w-[610px] float-end  mx-auto w-full hidden md:block",
                            ref: u,
                            children: (0, i.jsx)("div", {
                              className:
                                " md:max-w-[597px] max-w-[294px] shrink-0  justify-end gap-2 md:gap-3 content-center flex-wrap flex md:w-full items-center ",
                              children:
                                B &&
                                O.map((e, t) =>
                                  (0, i.jsxs)(
                                    l.E.div,
                                    {
                                      ...
                                      className:
                                        "flex md:py-2 md:px-3 p-2 justify-center items-center md:gap-2 gap-1 rounded-2xl bg-[#fff] mx-[3px]",
                                      children: [
                                        (0, i.jsxs)(w, {
                                          className: "w-4 h-4",
                                          children: [
                                            (0, i.jsx)(k, { src: e.image }),
                                            (0, i.jsx)(C, { children: "CN" }),
                                          ],
                                        }),
                                        (0, i.jsx)("div", {
                                          className:
                                            "text-[#262626] md:text-sm text-[12px] not-italic leading-normal  font-bold",
                                          children: e.name,
                                        }),
                                      ],
                                    },
                          ...
                          (0, i.jsx)("div", {
                            className:
                              " md:hidden rounded-3xl p-4 md:mr-2 md:mb-3 bg-[#F5F5F5] shrink-0  md:max-w-[610px] float-end  md:mx-auto w-full ",
                            ref: p,
                            children: (0, i.jsx)("div", {
                              className:
                                " md:max-w-[597px] max-w-[294px] shrink-0  justify-end gap-2 md:gap-3 content-center flex-wrap flex md:w-full items-center",
                              children: O.map((e, t) =>
                                (0, i.jsxs)(
                                  l.E.div,
                                  {
                                    ...
                                    className:
                                      "flex md:py-2 md:px-3 p-2 justify-center items-center md:gap-2 gap-1 rounded-2xl bg-[#fff] ",
                                    children: [
                                      (0, i.jsxs)(w, {
                                        className: "w-4 h-4",
                                        children: [
                  ...
                  (0, i.jsx)(l.E.div, {
                    initial: { opacity: 0, visibility: "hidden" },
                    animate: h ? { opacity: 1, visibility: "visible" } : {},
                    transition: { delay: 0.2, duration: 0.1 },
                    ref: u,
                    className:
                      "Incentive ml-6 rounded-b-3xl w-full max-w-[1346px] mb-8  h-[258px]  mt-24 items-center justify-center md:block hidden  text-white ",
                    children: (0, i.jsxs)(l.E.div, {
                      className:
                        "flex max-w-[717px] ml-14 pt-10 flex-col items-start gap-[21px]",
                      initial: { opacity: 0, y: 90 },
                      animate: h ? { opacity: 1, y: 0 } : {},
                      transition: { duration: 1, delay: 0.7, ease: y.mZ },
                      children: [
                        (0, i.jsxs)("div", {
                          className:
                          ...
                          children: [
                            (0, i.jsx)("h2", {
                              className:
                                "text-4xl not-italic font-bold leading-normal ",
                              children: "Dux Incentive Program",
                            }),
                            (0, i.jsx)("p", {
                              className:
                                "text-lg font-medium leading-normal self-stretch not-italic",
                              children:
                                "Early Buyers will get a chance at a $100,000 reward pool",
                            }),
                          ],
                        }),
                        (0, i.jsx)(o.default, {
                          ...
                          children: (0, i.jsx)(v, {
                            className:
                              "flex rounded-xl hover:bg-[#ff3838] bg-[#FF3838] px-4 pt-3.5 pb-3 justify-center items-center gap-2.5 text-lg font-medium leading-normal not-italic",
                            children: "Buy Now",
                          }),
                        }),
                      ],
                  ...
                  (0, i.jsx)(l.E.div, {
                    initial: { opacity: 0, visibility: "hidden" },
                    animate: j ? { opacity: 1, visibility: "visible" } : {},
                    transition: { delay: 0.2, duration: 0.1 },
                    ref: _,
                    className:
                      "IncentiveMobile max-w-[328px] mb-24 mt-24 w-full h-[500px] items-center justify-center md:hidden block text-white mx-auto",
                    children: (0, i.jsxs)(l.E.div, {
                      className:
                        "flex max-w-[328px] pt-10 flex-col items-center justify-center gap-[21px]",
                      initial: { opacity: 0, y: 90 },
                      animate: j ? { opacity: 1, y: 0 } : {},
                      transition: { duration: 1, delay: 0.5, ease: y.mZ },
                      children: [
                        (0, i.jsxs)("div", {
                          className:
                          ...
                          children: [
                            (0, i.jsx)("h2", {
                              className:
                                "text-3xl not-italic font-bold leading-normal ",
                              children: "Dux Incentive Program",
                            }),
                            (0, i.jsx)("p", {
                              className:
                                "text-base font-semibold leading-normal not-italic text-balance",
                              children:
                                "Early Buyers will get a chance at a $100,000 reward pool",
                            }),
                          ],
                        ...
                        (0, i.jsx)(o.default, {
                          ...
                          children: (0, i.jsx)(v, {
                            className:
                              "flex rounded-xl hover:bg-[#ff3838] bg-[#FF3838] px-4 pt-3.5 pb-3 justify-center items-center gap-2.5 text-lg font-semibold leading-normal not-italic",
                            children: "Buy Now",
                          }),
                        }),
                      ],
        ...
        E = (e) => {
          ...
          return (0, i.jsx)("p", {
            style: { "--shimmer-width": "".concat(r, "px") },
            className: (0, u.cn)(
              "mx-auto max-w-md  dark:text-neutral-400/70",
      ...
      function Z(e) {
        ...
        return (0, i.jsx)("div", {
          ...
          children: (0, i.jsx)("div", {
            className: (0, u.cn)(
              "group rounded-full border border-[#404040] bg-[#171717] text-base text-[#D4D4D4] transition-all ease-in hover:cursor-pointer hover:bg-neutral-200 dark:border-white/5 dark:bg-neutral-900 dark:hover:bg-neutral-800"
            ),
            children: (0, i.jsx)(E, {
              className:
      ...
      var Y = s(4300),
        A = s(1266),
        Q = s(1976);
      let z = d.createContext(null);
      function W() {
        let e = d.useContext(z);
      ...
      let P = d.forwardRef((e, t) => {
        let {
          ...
          [x, p] = (0, Y.Z)({ ...r, axis: "horizontal" === s ? "x" : "y" }, a),
          [f, h] = d.useState(!1),
          [_, j] = d.useState(!1),
          g = d.useCallback((e) => {
            e && (h(e.canScrollPrev()), j(e.canScrollNext()));
          }, []),
          y = d.useCallback(() => {
            null == p || p.scrollPrev();
          }, [p]),
          ...
          B = d.useCallback(
            (e) => {
              "ArrowLeft" === e.key
                ? (e.preventDefault(), y())
                : "ArrowRight" === e.key && (e.preventDefault(), m());
            },
            [y, m]
          );
        return (
      ...
      let T = d.forwardRef((e, t) => {
        let { className: s, ...r } = e,
          { carouselRef: o, orientation: a } = W();
        return (0, i.jsx)("div", {
          ref: o,
          ...
          children: (0, i.jsx)("div", {
            ...
            className: (0, u.cn)(
              "flex",
              "horizontal" === a ? "-ml-4" : "-mt-4 flex-col",
              s
            ),
            ...r,
          }),
      ...
      T.displayName = "CarouselContent";
      let q = d.forwardRef((e, t) => {
        let { className: s, ...r } = e,
          { orientation: o } = W();
        return (0, i.jsx)("div", {
          ref: t,
      ...
      function K() {
        ...
        let e = (0, d.useRef)(null),
          ...
          D = (0, d.useRef)(null),
          v = (0, n.Y)(D, { once: !0 }),
          O = (0, c.ac)({ query: "(max-width: 768px)" }),
          b = (e) => 3 * e,
          I = [
            {
              img: "/WebHosting.svg",
              title: (0, i.jsx)(i.Fragment, {
                children: (0, i.jsx)("span", {
                  className:
                    " self-stretch text-white md:text-xl text-lg not-italic   font-semibold leading-8",
                  children: "Web Hosting",
                }),
              }),
              desc: "decentralized web hosting, powered by Dux Decentralized DNS.",
              refstate: e,
              mrefstate: p,
              textrefstate: g,
              mtextrefstate: w,
        ...
        return (0, i.jsxs)("div", {
          children: [
            (0, i.jsx)("div", {
              className:
                "hidden lg:block max-w-[1320px]  w-full justify-center items-center gap-8 ",
              children: (0, i.jsx)(P, {
                children: (0, i.jsx)(T, {
                  children: I.map((e, s) =>
                    (0, i.jsx)(
                      q,
                      {
                        ...
                        children: (0, i.jsxs)(l.E.div, {
                          ...
                          className:
                            "flex flex-col  items-start  gap-y-8 box-grad p-5",
                          children: [
                            (0, i.jsx)(r.default, {
                              src: e.img,
                              alt: "alt",
                            ...
                            (0, i.jsxs)(l.E.div, {
                              ...
                              className:
                                "px-2 flex  flex-col gap-y-2  items-start",
                              ref: e.textrefstate,
                              children: [
                                (0, i.jsx)("h2", {
                                  className:
                                    "text-3xl font-semibold text-[#FCFCFC]",
                                  children: e.title,
                                }),
                                (0, i.jsx)("p", {
                                  className:
                                    " text-[#D4D4D4]  text-sm font-normal leading-5 lowercase  items-start self-start ",
                                  children: e.desc,
                                }),
                              ],
                            }),
                ...
                (0, i.jsx)(
                  l.E.div,
                  {
                    ...
                    animate: [
                      ...
                      : {},
                    transition: O
                      ? { duration: 0.75, delay: 0.1, ease: y.YQ }
                      : { duration: 1, delay: b(0.1 * t), ease: y.YQ },
                    className: "w-full md:w-1/2 p-2 py-5",
                    children: (0, i.jsxs)("div", {
                      className:
                        "flex flex-col items-center justify-center gap-y-10 box-grad p-6",
                      children: [
                        (0, i.jsx)(r.default, {
                          src: e.img,
                          alt: "alt",
                        ...
                        (0, i.jsxs)(l.E.div, {
                          ...
                          animate: [
                            ...
                            : {},
                          transition: O
                            ? { duration: 0.5, delay: 0.2, ease: y.YQ }
                            : { duration: 0.85, delay: b(0.1 * t), ease: y.YQ },
                          className: "px-2 flex flex-col gap-y-2  items-start",
                          ref: e.mtextrefstate,
                          children: [
                            (0, i.jsx)("h2", {
                              className:
                                "text-3xl text-[#FCFCFC] font-semibold",
                              children: e.title,
                            }),
                            (0, i.jsx)("p", {
                              className:
                                "text-base text-[#D4D4D4] items-start  ",
                              children: e.desc,
                            }),
                          ],
                        }),
      ...
      (q.displayName = "CarouselItem"),
        (d.forwardRef((e, t) => {
          let {
            ...
            { orientation: n, scrollPrev: l, canScrollPrev: d } = W();
          return (0, i.jsxs)(v, {
            ref: t,
            variant: r,
            size: o,
        ...
        (d.forwardRef((e, t) => {
          let {
            ...
            { orientation: n, scrollNext: l, canScrollNext: d } = W();
          return (0, i.jsxs)(v, {
            ref: t,
            variant: r,
            size: o,
      ...
      var $ = () =>
        ...
        J = () => {
          ...
          let Y = (0, c.ac)({ query: "(max-width: 768px)" });
          return (0, i.jsxs)(i.Fragment, {
            children: [
              (0, i.jsxs)("div", {
                children: [
                  (0, i.jsx)(l.E.div, {
                    ...
                    transition: { duration: 1, ease: y.mZ },
                    ref: o,
                    children: (0, i.jsx)(Z, {
                  ...
                  (0, i.jsx)(l.E.div, {
                    initial: { opacity: 0, y: 90 },
                    animate: a ? { opacity: 1, y: 0 } : {},
                    transition: { duration: 1, delay: 0.1, ease: y.mZ },
                    className:
                      "header-text text-center md:text-5xl text-4xl font-semibold flex-wrap mx-auto max-w-[450px] pt-8 pb-10 leading-tight sm:leading-normal px-8 sm:px-0",
              ...
              (0, i.jsxs)("div", {
                className:
                  "relative flex flex-col max-w-screen-2xl mx-auto w-11/12 items-center justify-center overflow-hidden bg-black ",
                children: [
                  (0, i.jsx)("div", {
                    className:
                      "flex flex-col items-center justify-center gap-y-14 max-w-screen-2xl mx-auto",
                    children: (0, i.jsxs)("div", {
                      className:
                        "grid w-11/12 grid-cols-1 md:grid-cols-6 gap-x-10 gap-y-12 md:w-full overflow-hidden",
                      children: [
                        (0, i.jsxs)(l.E.div, {
                          initial: { opacity: 0, y: 140 },
                          animate: p ? { opacity: 1, y: 0 } : {},
                          transition: Y
                            ? { duration: 0.75, ease: y.YQ }
                            : { duration: 1, ease: y.YQ },
                          className:
                            "col-span-3 md:col-span-2  border-card box-grad w-full py-4 flex flex-col gap-y-2",
                          ref: x,
                          children: [
                            (0, i.jsx)(r.default, {
                              src: V,
                            ...
                            (0, i.jsxs)(l.E.div, {
                              initial: Y
                                ? { opacity: 0, y: 60 }
                                : { opacity: 0, y: 30 },
                              animate: k ? { opacity: 1, y: 0 } : {},
                              ref: w,
                              transition: Y
                                ? { duration: 0.5, delay: 0.1, ease: y.YQ }
                                : { duration: 0.75, delay: 0.3, ease: y.YQ },
                              className: "w-5/6 mx-auto flex flex-col gap-y-2",
                              children: [
                                (0, i.jsx)("h6", {
                                  className:
                                    "text-[#FCFCFC]  md:text-xl not-italic leading-8 font-semibold",
                                  children: "Immerse in AI/LLM Training",
                                }),
                                (0, i.jsx)("p", {
                                  className:
                                    "text-[#D4D4D4] text-sm not-italic font-normal leading-5",
                                  children:
                                    "Unlock the full potential of AI with our advanced training platforms.",
                                }),
                              ],
                            }),
                          ],
                        ...
                        (0, i.jsxs)(l.E.div, {
                          ...
                          transition: Y
                            ? { duration: 0.75, delay: 0.1, ease: y.YQ }
                            : { duration: 1, delay: 0.3, ease: y.YQ },
                          ref: _,
                          className:
                            "col-span-3 md:col-span-2  box-grad border-card w-full py-4 flex flex-col gap-y-2",
                          children: [
                            (0, i.jsx)(r.default, {
                              src: L,
                              alt: "alt",
                            ...
                            (0, i.jsxs)(l.E.div, {
                              ...
                              transition: Y
                                ? { duration: 0.5, delay: 0.1, ease: y.YQ }
                                : { duration: 0.75, delay: 0.6, ease: y.YQ },
                              ref: C,
                              className: "w-5/6 mx-auto flex flex-col gap-y-2",
                              children: [
                                (0, i.jsx)("h6", {
                                  className:
                                    "text-[#FCFCFC]  md:text-xl not-italic leading-8 font-semibold",
                                  children: "Dux Exclusive AI Models",
                                }),
                                (0, i.jsx)("p", {
                                  className:
                                    "text-[#D4D4D4] text-sm not-italic font-normal leading-5",
                                  children:
                                    "Harness the power of AI with our proprietary, cutting-edge models.",
                                }),
                              ],
                            }),
                          ],
                        ...
                        (0, i.jsxs)(l.E.div, {
                          ...
                          transition: Y
                            ? { duration: 0.75, delay: 0.1, ease: y.YQ }
                            : { duration: 1, delay: 0.5, ease: y.YQ },
                          ref: g,
                          className:
                            "col-span-3 md:col-span-2  box-grad border-card w-full py-4 flex flex-col gap-y-2",
                          children: [
                            ...
                            (0, i.jsxs)(l.E.div, {
                              ...
                              transition: Y
                                ? { duration: 0.5, delay: 0.1, ease: y.YQ }
                                : { duration: 0.75, delay: 0.9, ease: y.YQ },
                              ref: D,
                              className: "w-5/6 mx-auto flex flex-col gap-y-2",
                              children: [
                                (0, i.jsx)("h6", {
                                ...
                                (0, i.jsx)("p", {
                                  className:
                                    "text-[#D4D4D4] text-sm not-italic font-normal leading-5",
                                  children:
                                    "Deploy AI solutions effortlessly with our intuitive one-click system.",
                                }),
                              ],
                            }),
                          ],
                        ...
                        (0, i.jsxs)(l.E.div, {
                          ...
                          ref: B,
                          className:
                            "col-span-3  box-grad border-card w-full py-4 flex flex-col-reverse md:flex-col gap-y-2 overflow-hidden",
                          children: [
                            (0, i.jsxs)(l.E.div, {
                              initial: Y
                                ? { opacity: 0, y: 60 }
                              ...
                              transition: Y
                                ? { duration: 0.5, delay: 0.1, ease: y.YQ }
                                : { duration: 0.75, delay: 1.2, ease: y.YQ },
                              ref: O,
                              className:
                                "w-5/6 mx-auto md:text-center flex flex-col md:items-center gap-y-2",
                              children: [
                                (0, i.jsx)("h6", {
                                  className:
                                    "text-[#FCFCFC]  md:text-xl not-italic leading-8 font-semibold",
                                ...
                                (0, i.jsx)("p", {
                                  className:
                                    "text-[#D4D4D4] text-sm not-italic font-normal leading-5 md:w-1/2",
                                  children:
                                    "Enhance performance and efficiency using our innovative D-Rings.",
                                }),
                              ],
                            }),
                            (0, i.jsx)("div", {
                        ...
                        (0, i.jsxs)(l.E.div, {
                          ...
                          children: [
                            (0, i.jsxs)(l.E.div, {
                              ...
                              transition: Y
                                ? { duration: 0.5, delay: 0.1, ease: y.YQ }
                                : { duration: 0.75, delay: 1.3, ease: y.YQ },
                              ref: I,
                              className:
                                "w-5/6 mx-auto md:text-center flex flex-col md:items-center  gap-y-2",
                              children: [
                                ...
                                (0, i.jsx)("p", {
                                  className:
                                    "text-[#D4D4D4] text-sm not-italic font-normal leading-5 md:w-1/2",
                                  children:
                                    "Live Stats GPU Nodes across Dux Network.",
                                }),
                              ],
                            }),
                            (0, i.jsxs)("div", {
                              ...
                              children: [
                                (0, i.jsx)(r.default, {
                                  ...
                                  alt: "alt",
                                  className:
                                    "pb-2 w-full h-fit md:block hidden",
                                }),
                                (0, i.jsx)("div", {
                                  className:
                                    "md:hidden block pb-2 w-full h-fit",
                                  children: (0, i.jsx)($, {}),
                                }),
                              ],
                            }),
                  ...
                  (0, i.jsxs)("div", {
                    className:
                      "flex flex-col w-full items-center sm:gap-y-8 py-20 sm:py-[160px] h-full max-w-screen-2xl mx-auto",
                    ref: u,
                    children: [
                      (0, i.jsx)(l.E.div, {
                        initial: { opacity: 0, y: 160 },
                      ...
                      (0, i.jsxs)("div", {
                        className:
                          "flex flex-col items-center text-center mt-8 sm:mt-0 px-8 sm:px-0",
                        children: [
                          (0, i.jsx)(l.E.h4, {
                            initial: { opacity: 0, y: 150 },
                            animate: h ? { opacity: 1, y: 0 } : {},
                            ...
                            className:
                              "text-4xl md:text-5xl font-semibold  hero-text2",
                            children: "Dux Cloud Services",
                          }),
                          (0, i.jsx)(l.E.p, {
                            initial: { opacity: 0, y: 160 },
                            animate: h ? { opacity: 1, y: 0 } : {},
                            ...
                            className:
                              "text-sm my-5 md:text-base text-[#FFF] max-w-[626px] leading-7 text-center mx-auto font-medium",
                            children:
                              "Democratizing the decentralized infrastructure services for Web3, backed by our L2 blockchain tailored for infra transactions.",
                          }),
                        ],
                      }),
                      (0, i.jsx)(K, {}),
        ...
        et = () => {
          ...
          return (0, i.jsx)(i.Fragment, {
            children: (0, i.jsxs)("div", {
              className:
                "3xl:h-fit flex items-center justify-center flex-col w-full mb-20 pt-8 box-grid1",
              children: [
                (0, i.jsxs)("div", {
                  className:
                    "flex max-w-[428px] sm:w-full flex-col justify-center items-center gap-4 mx-auto mb-3 ",
                  children: [
                    (0, i.jsx)(l.E.div, {
                    ...
                    (0, i.jsxs)("div", {
                      className:
                        "flex flex-col items-center gap-2 justify-center self-stretch ",
                      children: [
                        (0, i.jsx)(l.E.div, {
                          initial: { opacity: 0, y: 90 },
                          animate: t ? { opacity: 1, y: 0 } : {},
                          transition: { duration: 1, delay: 0.2, ease: y.YQ },
                          className:
                            "self-stretch sub-headings text-center text-4xl md:text-5xl leading-normal font-semibold not-italic",
                          children: "Dux Subnets",
                        }),
                        (0, i.jsx)(l.E.p, {
                          initial: { opacity: 0, y: 90 },
                          animate: t ? { opacity: 1, y: 0 } : {},
                          transition: { duration: 1, delay: 0.3, ease: y.YQ },
                          className:
                            "text-[#171717] self-stretch text-center text-sm not-italic leading-[24px] font-normal text-balance",
                          children:
                            "AI-powered L3 blockchain with a complete suite of decentralized cloud services for enterprises.",
                        }),
                      ],
                    }),
                  ],
                ...
                (0, i.jsxs)(l.E.div, {
                  initial: { opacity: 0, y: 120 },
                  animate: t ? { opacity: 1, y: 0 } : {},
                  transition: { duration: 1, delay: 0.4, ease: y.YQ },
                  className:
                    "subnet-L3 max-w-[327px] mb-[10px] flex items-start flex-col md:max-w-[605px] w-full mx-auto shrink-0 md:flex-row px-4 py-4 sm:py-2 shadow-xl",
                  children: [
                    (0, i.jsxs)("div", {
                      className:
                        "flex max-w-[228px] md:max-w-[691px] w-full flex-col  justify-center items-start gap-2 ml-2 mt-1",
                      children: [
                        (0, i.jsx)(l.E.h3, {
                          initial: { opacity: 0, y: 50 },
                          animate: t ? { opacity: 1, y: 0 } : {},
                          transition: { duration: 1, delay: 1.2, ease: y.YQ },
                          className:
                            "self-stretch text-[#171717] text-lg  font-semibold leading-[32px] not-italic md:mt-3",
                          children: "AI Powered L3",
                        }),
                        (0, i.jsx)(l.E.div, {
                          initial: { opacity: 0, y: 50 },
                          animate: t ? { opacity: 1, y: 0 } : {},
                          transition: { duration: 1, delay: 1.3, ease: y.YQ },
                          className:
                            "text-[#525252] text-sm font-normal leading-5 self-stretch",
                          children:
                            "A tailored L3 blockchain for enterprises, powered by Dux AI.",
                        }),
                        (0, i.jsx)(l.E.div, {
                          initial: { opacity: 0, y: 50 },
                          animate: t ? { opacity: 1, y: 0 } : {},
                          transition: { duration: 1, delay: 1.4, ease: y.YQ },
                          className: "ml-2",
                          children: (0, i.jsx)("button", {
                            className:
                              "rounded-3xl  border border-[#FF3838] bg-[#fff] gap-2.5 items-center justify-center py-2 px-4 flex text-[#FF3838] text-sm font-normal leading-normal mt-4",
      ...
      let es = [
          { img: "/img1.png", name: "Dexter" },
          { img: "/img2.png", name: "Diesel" },
          { img: "/img3.png", name: "Joules" },
          { img: "/img4.png", name: "Haze" },
        ],
        ei = (e) => 3 * e;
      var er = () => {
          let e = (0, d.useRef)(null),
            ...
            x = (0, d.useRef)(null),
            p = (0, n.Y)(x, { once: !0 }),
            f = (0, c.ac)({ query: "(max-width: 768px)" });
          return (0, i.jsx)(i.Fragment, {
            children: (0, i.jsxs)("div", {
              className:
                "flex flex-col w-full items-center py-10 md:max-w-screen-2xl mx-auto bg-white  ",
              children: [
                (0, i.jsxs)("div", {
                  ref: e,
                  className:
                    "flex flex-col w-full items-center py-10 md:max-w-screen-2xl mx-auto bg-white box-grid1",
                  children: [],
                }),
                (0, i.jsx)(et, {}),
              ],
                  ...
                  (0, i.jsx)("defs", {
                    children: (0, i.jsxs)("filter", {
                      ...
                      children: [
                        ...
                        (0, i.jsxs)("feMerge", {
                          children: [
                            (0, i.jsx)("feMergeNode", { in: "coloredBlur" }),
                  ...
                  (0, i.jsxs)("g", {
                    ...
                    children: [
                      (0, i.jsx)("rect", {
                        ...
                        rx: "3.5",
                        transform:
                          "matrix(-4.37114e-08 1 1 4.37114e-08 673 190)",
                        fill: "#171717",
                      ...
                      (0, i.jsx)("rect", {
                        ...
                        rx: "3.5",
                        transform:
                          "matrix(-4.37114e-08 1 1 4.37114e-08 688 190)",
                        fill: "#171717",
                      ...
                      (0, i.jsx)("rect", {
                        ...
                        rx: "3.5",
                        transform:
                          "matrix(-4.37114e-08 1 1 4.37114e-08 703 190)",
                        fill: "#171717",
                      ...
                      (0, i.jsx)("rect", {
                        ...
                        rx: "3.5",
                        transform:
                          "matrix(-4.37114e-08 1 1 4.37114e-08 718 190)",
                        fill: "#171717",
              ...
              (0, i.jsxs)("defs", {
                children: [
                  ...
                  (0, i.jsxs)("linearGradient", {
                    ...
                    gradientUnits: "userSpaceOnUse",
                    children: [
                      (0, i.jsx)("stop", { "stop-color": "#464646" }),
                      (0, i.jsx)("stop", {
                        offset: "1",
                        "stop-color": "#737373",
                        "stop-opacity": "0",
                  ...
                  (0, i.jsxs)("linearGradient", {
                    ...
                    gradientUnits: "userSpaceOnUse",
                    children: [
                      (0, i.jsx)("stop", { "stop-color": "#D2D2D2" }),
                      (0, i.jsx)("stop", {
                        offset: "1",
                        "stop-color": "#262626",
                      }),
          ...
          return (0, i.jsxs)("div", {
            ...
            children: [
              (0, i.jsx)(l.E.div, {
                ...
                animate: s ? { opacity: 1, y: 0 } : {},
                transition: e
                  ? { duration: 1, delay: 1.5, ease: y.mZ }
                  : { duration: 1, delay: 1.8, ease: y.mZ },
                children: (0, i.jsx)(Z, { Shinytext: "✨  Beta Release" }),
              }),
              (0, i.jsxs)("div", {
                className:
                  "flex flex-col md:items-center items-center justify-center gap-y-8 p-4 mt-4 pb-4",
                children: [
                  (0, i.jsxs)(l.E.div, {
                    initial: { opacity: 0, y: 90 },
                    animate: s ? { opacity: 1, y: 0 } : {},
                    transition: e
                      ? { duration: 1, delay: 1.6, ease: y.mZ }
                      : { duration: 1, delay: 1.9, ease: y.mZ },
                    className:
                      "hidden font-latom  text-4xl md:text-6xl font-semibold md:text-center hero-text1 gap-y-5 md:flex flex-col leading-normal",
                    children: [
                      (0, i.jsx)("h2", {
                  ...
                  (0, i.jsxs)("div", {
                    className:
                      "md:hidden text-5xl md:text-6xl font-semibold md:text-center  gap-y-2 flex flex-col leading-snug",
                    children: [
                      (0, i.jsxs)(l.E.h2, {
                        initial: { opacity: 0, y: 90 },
                        animate: s ? { opacity: 1, y: 0 } : {},
                        transition: e
                          ? { duration: 1, delay: 1.7, ease: y.mZ }
                          : { duration: 1, delay: 2, ease: y.mZ },
                        className:
                          "flex flex-col items-center text-[#FFF] self-stretch",
                        children: [
                          "Empowering",
                          (0, i.jsx)("span", {
                      ...
                      (0, i.jsxs)(l.E.h2, {
                        ...
                        transition: e
                          ? { duration: 1, delay: 1.8, ease: y.mZ }
                          : { duration: 1, delay: 2.1, ease: y.mZ },
                        className:
                          "text-5xl md:text-5xl hero-text2 flex items-center flex-col",
                        children: [
                          "decentralized",
                          (0, i.jsx)("span", {
                  ...
                  (0, i.jsxs)(l.E.p, {
                    ...
                    transition: e
                      ? { duration: 1, delay: 1.9, ease: y.mZ }
                      : { duration: 1, delay: 2.4, ease: y.mZ },
                    className:
                      "text-[#D4D4D4] font-normal md:text-lg text-sm items-center text-center md:text-center md:max-w-[984px]  leading-relaxed",
                    children: [
                      "Dux Network pioneers true Decentralized computing solutions for the emerging AI economy. Our comprehensive suite of offerings is designed to immerse web3 enthusiasts in authentic decentralized AI",
                      (0, i.jsx)("span", {
                      ...
                      (0, i.jsx)("span", {
                        ...
                        children:
                          ", leveraging the robust Dux GPU network and cloud solutions.",
                      }),
                    ],
                  }),
                  (0, i.jsx)(o.default, {
                    ...
                    children: (0, i.jsx)(l.E.button, {
                      ...
                      transition: e
                        ...
                        : { duration: 1, delay: 2.3, ease: y.YQ },
                      className:
                        "inline-flex py-3.5 px-8 justify-center items-center gap-2.5 rounded-3xl bg-[#FF3838] text-[#fff] text-lg font-bold not-italic leading-normal",
                          ...
                          (0, i.jsxs)("g", {
                            ...
                            children: [
                              (0, i.jsx)("rect", {
                                ...
                                rx: "2.8",
                                transform:
                                  "matrix(-4.37114e-08 1 1 4.37114e-08 174.1 158)",
                                fill: "#171717",
                              ...
                              (0, i.jsx)("rect", {
                                ...
                                rx: "2.8",
                                transform:
                                  "matrix(-4.37114e-08 1 1 4.37114e-08 186.1 158)",
                                fill: "#171717",
                              ...
                              (0, i.jsx)("rect", {
                                ...
                                rx: "2.8",
                                transform:
                                  "matrix(-4.37114e-08 1 1 4.37114e-08 198.1 158)",
                                fill: "#171717",
                              ...
                              (0, i.jsx)("rect", {
                                ...
                                rx: "2.8",
                                transform:
                                  "matrix(-4.37114e-08 1 1 4.37114e-08 210.1 158)",
                                fill: "#171717",
                            ...
                            (0, i.jsxs)("g", {
                              ...
                              children: [
                                (0, i.jsx)("rect", {
                                  ...
                                  rx: "20.1546",
                                  transform:
                                    "matrix(-4.37114e-08 1 1 4.37114e-08 43 316.899)",
                                  fill: "#161615",
                                }),
                                (0, i.jsx)("rect", {
                                  x: "0.806186",
                        ...
                        children: (0, i.jsxs)("g", {
                          ...
                          children: [
                            (0, i.jsx)("rect", {
                              ...
                              rx: "2.82165",
                              transform:
                                "matrix(-4.37114e-08 -1 -1 4.37114e-08 312.084 317.705)",
                              fill: "#171717",
      ...
      function el() {
        ...
        return (0, i.jsxs)("main", {
          ...
          children: [
            (0, i.jsxs)("div", {
              className:
                "flex flex-col items-center justify-center relative max-w-screen-2xl w-11/12 mx-auto mt-4 sm:mt-4",
              children: [
                (0, i.jsx)(ea, {}),
                (0, i.jsx)(l.E.div, {
                  initial: { opacity: 0, y: 100, scale: 0.8 },
                  animate: t ? { opacity: 1, y: 0, scale: 1 } : {},
                  transition: { duration: 0.75, delay: 1.7, ease: y.YQ },
                ...
                (0, i.jsx)(l.E.div, {
                  initial: { opacity: 0, y: 100, scale: 0.8 },
                  animate: r ? { opacity: 1, y: 0, scale: 1 } : {},
                  transition: { duration: 0.75, delay: 1, ease: y.YQ },
  ...
  function (e) {
    e.O(0, [44, 548, 971, 23, 744], function () {
      return e((e.s = 193));
    }),
      (_N_E = e.O());
  },
